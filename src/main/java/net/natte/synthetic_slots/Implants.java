...
public class Implants {
    ...
    public static final Implant AUGMENT_BRAIN_CHIP       = register(new Implant("augment_brain_chip", "Augment Brain Chip", "Increases cognitive functions", "slight increase to xp gain", BRAIN, ImplantEffects.SMALL_XP_BOOST));
    public static final Implant AUGMENT_SHIELD           = register(new Implant("augment_shield", "Augment Shield", "increases resistance to poison", "increases resistance to poison", IDK, ImplantEffects.description("poison_immunity")));
    ...
    public static final Implant CYBER_ARM                = register(new Implant("cyber_arm", "Cyber Arm", "Engineered for strength and precision", "more strength", ARM, ImplantEffects.attackDamage("Cyber-Arm-Strength", 4)));
    public static final Implant CYBER_BRAIN              = register(new Implant("cyber_brain", "Cyber Brain", "Enhances brain functions", "significant boost in the xp you gain", BRAIN, ImplantEffects.LARGE_XP_BOOST));
    ...
    public static final Implant PLASMA_PULSE_ARM         = register(new Implant("plasma_pulse_arm", "Plasma Pulse Arm", "increase attack", "increase attack", ARM, ImplantEffects.attackDamage("Plasma-Arm-Strength", 6)));
    ...
    public static final Implant SERVO_MOTOR_ARM          = register(new Implant("servo_motor_arm", "Servo Motor Arm", "increases attack strength", "increases attack strength", ARM, ImplantEffects.attackDamage("Servo-Arm-Strength", 2)));
